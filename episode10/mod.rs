...
unsafe fn krool_attackhi4(fighter: &mut L2CAgentBase) {
...
unsafe fn krool_specialhi(fighter: &mut L2CAgentBase) {
	...
	if macros::is_excute(fighter) {
		if ControlModule::check_button_on(fighter.module_accessor, *CONTROL_PAD_BUTTON_ATTACK) {
			...
			StatusModule::change_status_request_from_script(fighter.module_accessor, FIGHTER_STATUS_KIND_ATTACK_AIR.into(), true);
