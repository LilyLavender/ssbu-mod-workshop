...
| 0x158507c5b5 | collision_attr_pierce | 📝 An effect similar to the crumple status, but with different params in common.prc. Only used on Corrin's Side Special. | Atttack | <!-- Figure out exactly how it differs from other crumple statuses. -->
