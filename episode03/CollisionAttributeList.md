...
| 0x197da285b7 | collision_attr_**odin_slash** | 📝 Used only on the Odin summon on Midgar's slash attack. Does not affect buried opponents. | Hit | <!-- Need a general description of what it looks like. If it's similar to another hit effect, mention how it differs. May also have additional effects. Figure out if it's Midgar-specific. -->
