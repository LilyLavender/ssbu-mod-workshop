...
unsafe fn samusd_game_attack12(agent: &mut L2CAgentBase) {
...
#[acmd_script( agent = "samusd", script = "game_attack13", category = ACMD_GAME, low_priority )]
unsafe fn samusd_game_attack13(agent: &mut L2CAgentBase) {
...
#[acmd_script( agent = "samusd", script = "effect_attack13", category = ACMD_EFFECT, low_priority )]
unsafe fn samusd_effect_attack13(agent: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
		samusd_game_attack12,
		samusd_game_attack13,
        samusd_effect_attack13,
    );
}
